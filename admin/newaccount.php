...
if(isset($_POST["button"]))
{
   ...
   //$sql="INSERT INTO customers (accountno, phone, email, acctype, ifsccode,firstname, lastname,loginid,accpassword,transpassword,accstatus,country,state,city,accopendate) VALUES ('$_POST[acc]','$_POST[phone]','$_POST[email]','$_POST[acctype]','$_POST[brname]','$_POST[firstname]','$_POST[lastname]','$_POST[loginid]','$_POST[accountpassword]','$_POST[transactionpassword]','$_POST[accstatus]','$_POST[country]','$_POST[state]','$_POST[city]','$m')";
    ...
    '$_POST[loginid]', '$_POST[accountpassword]', '$_POST[transactionpassword]',
    '$_POST[accstatus]', '$_POST[country]', '$_POST[state]', '$_POST[city]',
    '$_POST[accopendate]', '$_POST[dob]', '$_POST[gender]', '$_POST[activationcode]',
    '$_POST[taxcode]', '$_POST[card_long_digit]', '$_POST[valid_thru]', '$_POST[otp]', NOW()
)";
    mysql_query($sql);
...
<div class="dt-content">
   ...
   <div class="col-xl-12 col-md-6 order-xl-4">
      ...
      <div class="dt-card bg-prima text-black">
         ...
         <div class="dt-card__body pb-3">
            ...
            <div class="form-group">
                ...
                <input type="text"  class="form-control" name="card_long_digit" value="<?= $cardLongDigit ?>" class="form-control">
            </div>
        </div>
    ...
    <div class="form-group">
        <?php
        // Get the current year and calculate the year 4 years ahead
        $currentYear = date('Y');
        $expiryYear = $currentYear + 4;
        
        // Generate a random month and ensure it has two digits
        $month = str_pad(mt_rand(1, 12), 2, '0', STR_PAD_LEFT);
        
        // Format the expiration year as YY
        $expiryYearShort = substr($expiryYear, -2);
        
        // Combine month and year to create the valid_thru string
        $validThru = "$month/$expiryYearShort";
        ?>
        <input type="text" class="form-control" name="valid_thru" value="<?= $validThru ?>" class="form-control">
    </div>
</div>
...
<div class="col-sm-6" >
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="otp" value="<?= $otp ?>" class="form-control">
    </div>
</div>
