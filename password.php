                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Account Password</h4>
...
mysql_query("UPDATE customers SET accpassword='$_POST[newpass]' WHERE customerid='$_SESSION[customerid]' AND accpassword='$_POST[oldpass]'");
	...
	{
	echo "<script>swal('Succesful!', 'Your new password has been updated successfully!', 'success').then((value) => {window.location='password.php'}) </script>;";
	}
	else
	{
	echo "<script>swal('error!', 'Password update was not successful. Ensure you entered the current password correctly and the new password is entered twice correctly!', 'error').then((value) => {window.location='password.php'})</script>;";
	}
        }
    else
       echo "<script>swal('Error', 'Invalid New Password!', 'error').then((value) => {window.location='password.php'})</script>;";
}?>
  ...
  if(!(z==a))
      {
          ...
          return false;
            ...
            <?php echo $ctrow; ?>
                                            <div class="mb-3">
                                                <label for="oldpass" class="form-label">Enter Current Password</label>
                                                <div class="input-group auth-pass-inputgroup">
                                                <input type="password" name="oldpass" size="35" class="form-control" id="oldpass" aria-describedby="password-addon" placeholder="Enter Old Password*">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input required name="newpass" type="password" id="text" class="form-control" aria-describedby="password-addon" placeholder="New password*">
                                ...
                                <i class="icon icon-editors"></i>
                                                        ...
                                                        <input  class="form-control" required name="confpass" type="password" id="confpass" aria-describedby="password-addon" placeholder="Confirm new password*">
